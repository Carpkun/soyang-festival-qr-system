    ...
    if (printWindow && booth) {
          ...
          <body>
            <div class="qr-print-container">
              ...
              <div class="info">
                ...
                <p><strong>QR 데이터:</strong> https://soyang-festival-qr-system-oh27.vercel.app/?boothId=${booth.id}</p>
              </div>
              <div class="footer">
      ...
      import('react-qr-code').then(() => {
        ...
        if (qrContainer) {
          ...
          qrContainer.innerHTML = `<div style="border: 1px solid #ccc; padding: 20px; background: #f9f9f9;">QR 코드 영역<br/>https://soyang-festival-qr-system-oh27.vercel.app/?boothId=${booth.id}</div>`;
        }
      });
          ...
          <body>
            ...
            <div class="qr-grid">
              ${booths.map(booth => `
                <div class="qr-item">
                  <h3>${booth.name}</h3>
                  <div class="qr-placeholder">QR 코드 영역<br/>https://soyang-festival-qr-system-oh27.vercel.app/?boothId=${booth.id}</div>
                  <p><strong>부스 ID:</strong> ${booth.id}</p>
